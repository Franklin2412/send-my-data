class ReceiverController < ApplicationController
  ...
  def sample_merchant_details
    {"LLKwG0" => "qauKbEAJ", "gtKFFx" => "eCwWELxi", "smsplus" => "admin", "0MQaQP" => "13p0PXZk", "PqvxqV" => "6SPh4Ulq", "obScKz" => "Ml7XBCdR", "DXOF8m" => "2Hl5U0En", "WhccBa" => "UX5K0KvP", "ukgVCk" => "DzSugFtI", "ihRGm8" => "2JITyIgq"}
  end
